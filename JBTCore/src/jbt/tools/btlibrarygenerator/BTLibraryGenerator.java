...
//			You need to specify the configuration fileName its required....
			System.out.println("configuration_file_name: " + configurationFileName);
//			System.exit(0);
			...
			for (Element currentBTLibrary : btLibrariesDescription) {
				try {
					...
					System.out.println("There was an unexpected error while creating the current BT library. Skipped to next");
					e.printStackTrace();
				}
			}
		} catch (Exception e) {
